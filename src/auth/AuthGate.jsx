...
// Suite-standard 8-digit email-OTP gate (shared Supabase project, per-user RLS).
// Session is shared same-origin across suite apps. Copied from cue-app.
  ...
  return (
    <div className="auth-shell">
      <div className="auth-card">
        <div className="auth-eyebrow">Course</div>
