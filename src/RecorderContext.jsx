...
export function RecorderProvider({ go, children }) {
  ...
  }), [phase, seconds, error, warn, interrupted, title, home, pillar, projects, seriesId, people, agenda, notes, source, detail, lines, transcriptText, synth, cost, speakers, diarize, recoveredBlob, engine, tStatus, modelPct, tabAudio, tabMixed, storageWarn, pins])
